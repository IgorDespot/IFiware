...
def deploy_app(idm_host, user, password):
    ...
    app = open('Fiware/main_app.pckl', 'wb')
    pk.dump(main_app, app)
    app.close()
    user_id = {}
    app = open('Fiware/user_id.pckl', 'wb')
    ...
    app.close()
    permission_id = {}
    app = open('Fiware/permission_id.pckl', 'wb')
    ...
    app.close()
    role_id = {}
    app = open('Fiware/role_id.pckl', 'wb')
...
def get_access_token(idm_host, user, password):
    ...
    app = open('Fiware/main_app.pckl', 'rb')
